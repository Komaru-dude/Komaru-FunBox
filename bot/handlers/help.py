...
async def cmd_help(message: Message, bot: Bot):
    try:
        ...
        mod_detailed_descriptions = {
            "who": "💬 Если кто-то ответит на сообщение словами \"это что?\", бот спросит у нейросети (gemini-2.0-flash), что это такое.\n\n⚠️ Работает только с текстом",
