...
async def cmd_help(message: Message, bot: Bot):
    try:
        ...
        cmd_detailed_descriptions = {
            ...
            "agai": "Более злая версия нейросети, маты, просьбы отправится куда подальше, всё это включено в эту команду.\nИспользуется <a href='https://api.onlysq.ru/'>этот</a> API.\n\nПример: <code>/agai Привет, я умный</code>\n\nДобавьте <code>-m *имя модели*</code> для использования конкретной модели, посмотреть доступные модели: <code>/available_models</code>",
            "chat": "Начинает чат с ИИ.\nИспользуйте <code>-argue</code> для начала спора.\nИспользуйте <code>-aggressive</code> для запуска 'злого' чата\nИспользуется <a href='https://api.onlysq.ru/'>этот</a> API.\n\nОстановить чат можно через <code>/chat_stop</code>",
            "chat_clear": "Очищает чат с ИИ\nНе работает на других пользователей, если хотите остановить используйте <code>/chat_stop</code>",
        ...
        mod_short_descriptions = {
            ...
            "sendcooldown": "Отправляет сообщение если команда в кулдауне",
        }
        ...
        mod_detailed_descriptions = {
            ...
            "sendcooldown": "⏳ Если включено отправляет сообщение при попытке вызвать команду в кулдауне",
        }
