...
async def cmd_help(message: Message, bot: Bot):
    try:
        cmd_short_descriptions = {
            ...
            "ai": "Бот сделает запрос к gpt-4o",
            "agai": '"Злая" версия gemini-2.0-flash',
        ...
        cmd_detailed_descriptions = {
            ...
            "ai": "Бот сделает запрос к текстовой модели gpt-4o-mini с использованием <a href='https://api.onlysq.ru/'>этого</a> API.\nПример: <code>/ai Придумай рецепт оладушков.</code>\nДля указания модели используйте этот пример: <code>/ai *модель (например gemini-2.0-flash)* Привет, расскажи о моделях gemini</code>",
            "agai": "Более злая версия gemini-2.0-flash, маты, просьбы отправится куда подальше, всё это включено в эту команду.\nИспользуется <a href='https://api.onlysq.ru/'>этот</a> API.\nПример: <code>/agai Привет, я умный</code>",
