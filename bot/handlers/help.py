...
async def cmd_help(message: Message):
    ...
    mod_detailed_descriptions = {
        ...
        "warn": "📝 Модуль добавляет команду /warn, с помощью которой можно выдавать предупреждения пользователям.",
        "mute": "🔇 Позволяет временно отключать пользователям возможность отправлять сообщения через команду /mute.",
        "ban": "📛 Разрешает команду /ban, с помощью которой можно блокировать пользователей навсегда или на определённое время."
    }
