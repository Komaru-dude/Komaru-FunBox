...
@invest_router.callback_query(InvestMenuCallback.filter(action="buy_stock"))
...
@invest_router.callback_query(InvestMenuCallback.filter(action="buy_stock_item"))
...
@invest_router.callback_query(InvestMenuCallback.filter(action="sell_stock"))
...
@invest_router.callback_query(InvestMenuCallback.filter(action="my_portfolio"))
