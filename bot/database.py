...
DEFAULT_SETTINGS = [
    ...
    ("send_welcome_msg", "Приветствия", bool, False, "Разрешает боту отправлять приветственные сообщения"),
    ("welcome_message", "Приветствия", str, "Добро пожаловать!", "Приветственное сообщение, работает только при включённом send_welcome_msg"),
